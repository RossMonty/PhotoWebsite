...
/* @overview/index.twig */
class __TwigTemplate_cf383db2f77152183cb547d1abc08209411d0cd61a5880cae03188283ed67db1 extends Twig_SupTwg_Template
{
...
\t\t\t\t\t\tLearn more about it in <a href=\"//supsystic.com/main-settings/\" target=\"_blank\">Main Settings.</a>
                ...
                <a href=\"";
        // line 61
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["environment"] ?? null), "generateUrl", array(0 => "promo", 1 => "showTutorial"), "method"), "html", null, true);
        echo "\" class=\"button button-primary button-hero\">
                    <i class=\"fa fa-info-circle\"></i>
                    ";
        // line 63
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Start step-by-step tutorial")), "html", null, true);
        echo "
                </a>
        ...
        echo "</div>
                <a href=\"https://kinsta.com?kaid=MNRQQASUYJRT\">
                    <img src=\"";
        // line 83
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('plugin_directory_url')->getCallable(), array("app/assets/img/kinsta_banner.png")), "html", null, true);
        ...
        $context['_seq'] = Twig_SupTwg_ensure_traversable(($context["serverSettings"] ?? null));
        foreach ($context['_seq'] as $context["title"] => $context["element"]) {
            // line 90
            echo "                        <li class=\"settings-line\" style=\"float: none;\">
                            <div class=\"settings-title\">";
            // line 91
            echo Twig_SupTwg_escape_filter($this->env, Twig_SupTwg_trim_filter($context["title"]), "html", null, true);
            echo ":</div>
                            <span>";
            // line 92
            echo Twig_SupTwg_escape_filter($this->env, Twig_SupTwg_trim_filter($this->getAttribute($context["element"], "value", array())), "html", null, true);
            echo "</span>
                        </li>
                    ";
        }
...
$context["form"]->gettext("subject", "", array("required" => "")));
        ...
        // line 131
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Topic")), "html", null, true);
        echo "</label>
                        </th>
                        <td>
                            <select id=\"select-question\" name=\"question\">
                                <option value=\"plugin_options\">
                                    ";
        // line 136
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Plugin options")), "html", null, true);
        echo "
                                </option>
                                <option value=\"bug\">
                                    ";
        // line 139
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Report a bug")), "html", null, true);
        echo "
                                </option>
                                <option value=\"functionallity\">
                                    ";
        // line 142
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Require a new functionallity")), "html", null, true);
        echo "
                                </option>
                                <option value=\"other\">
                                    ";
        // line 145
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Other")), "html", null, true);
        echo "
                                </option>
                            </select>
                        </td>
                    ...
                    <tr>
                        <th scope=\"row\" style=\"vertical-align: top;\">
                            <label for=\"mail-text\">";
        // line 152
        echo Twig_SupTwg_escape_filter($this->env, (call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Message")) . " *"), "html", null, true);
        echo "</label>
                        </th>
                        <td>
                            <textarea id=\"mail-text\" name=\"message\" cols=\"50\" rows=\"3\" placeholder=\"";
        // line 155
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Hello Supsystic Team!")), "html", null, true);
...
";
    ...
    {
        return new Twig_SupTwg_Source("", "@overview/index.twig", "C:\\wamp64\\www\\PhotoWebsite\\wp-content\\plugins\\gallery-by-supsystic\\src\\GridGallery\\Overview\\views\\index.twig");
    }
}
